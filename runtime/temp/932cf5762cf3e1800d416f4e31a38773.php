    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-9">
            <div class="input-group">
                <input id="c-fa_img" class="form-control" size="50" name="row[fa_img]" type="text">
