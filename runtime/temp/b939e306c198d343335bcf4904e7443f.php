<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:70:"G:\svn_home\szcxmx\public/../application/admin\view\solution\edit.html";i:1531277341;s:61:"G:\svn_home\szcxmx\application\admin\view\layout\default.html";i:1529292885;s:58:"G:\svn_home\szcxmx\application\admin\view\common\meta.html";i:1529292885;s:60:"G:\svn_home\szcxmx\application\admin\view\common\script.html";i:1529292885;}*/ ?>
<!DOCTYPE html>
...
<script type="text/javascript">
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <input id="c-question" class="form-control" name="row[question]" type="text" value="<?php echo $row['question']; ?>">
        </div>
    </div>
    <div class="form-group">
        <label class="control-label col-xs-12 col-sm-2"><?php echo __('Special'); ?>:</label>
        <div class="col-xs-12 col-sm-8">
            <input id="c-special" class="form-control" name="row[special]" type="text" value="<?php echo $row['special']; ?>">
        </div>
    </div>
    <div class="form-group">
        <label class="control-label col-xs-12 col-sm-2"><?php echo __('Function'); ?>:</label>
        <div class="col-xs-12 col-sm-8">
            <input id="c-function" class="form-control" name="row[function]" type="text" value="<?php echo $row['function']; ?>">
        </div>
    </div>
    <div class="form-group">
        <label class="control-label col-xs-12 col-sm-2"><?php echo __('Similar'); ?>:</label>
        <div class="col-xs-12 col-sm-8">
            <input id="c-similar" class="form-control" name="row[similar]" type="text" value="<?php echo $row['similar']; ?>">
        </div>
    </div>
