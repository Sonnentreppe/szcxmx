<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:78:"G:\svn_home\szcxmx\public/../application/admin\view\solution\ability\edit.html";i:1531362495;s:61:"G:\svn_home\szcxmx\application\admin\view\layout\default.html";i:1529292885;s:58:"G:\svn_home\szcxmx\application\admin\view\common\meta.html";i:1531379234;s:60:"G:\svn_home\szcxmx\application\admin\view\common\script.html";i:1531379235;}*/ ?>
<!DOCTYPE html>
...
<script type="text/javascript">
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <div class="input-group">
                <input id="c-img" class="form-control" size="50" name="row[img]" type="text" value="<?php echo $row['img']; ?>">
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <input id="c-content" class="form-control" name="row[content]" type="text" value="<?php echo $row['content']; ?>">
        </div>
    </div>
