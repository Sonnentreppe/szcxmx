<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:78:"G:\svn_home\szcxmx\public/../application/admin\view\solution\solution\add.html";i:1531284703;s:61:"G:\svn_home\szcxmx\application\admin\view\layout\default.html";i:1529292885;s:58:"G:\svn_home\szcxmx\application\admin\view\common\meta.html";i:1529292885;s:60:"G:\svn_home\szcxmx\application\admin\view\common\script.html";i:1529292885;}*/ ?>
<!DOCTYPE html>
...
<script type="text/javascript">
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <input id="c-class" class="form-control" name="row[class]" type="number">
        </div>
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
        <label class="control-label col-xs-12 col-sm-2"><?php echo __('Special_list'); ?>:</label>
        <div class="col-xs-12 col-sm-8">
            <?php echo build_select('row[special_list]', $group,1,['class' => 'form-control selectpicker']); ?>
        </div>
    </div>
    <div class="form-group">
        <label class="control-label col-xs-12 col-sm-2"><?php echo __('Function_list'); ?>:</label>
        <div class="col-xs-12 col-sm-8">
            <input id="c-function_list" class="form-control" name="row[function_list]" type="text">
        </div>
    </div>
    <div class="form-group">
        <label class="control-label col-xs-12 col-sm-2"><?php echo __('Similar_list'); ?>:</label>
        <div class="col-xs-12 col-sm-8">
            <input id="c-similar_list" class="form-control" name="row[similar_list]" type="text">
        </div>
    </div>
    <div class="form-group">
