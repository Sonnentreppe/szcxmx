<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:68:"G:\svn_home\szcxmx\public/../application/admin\view\index\login.html";i:1531379234;s:58:"G:\svn_home\szcxmx\application\admin\view\common\meta.html";i:1531379234;s:60:"G:\svn_home\szcxmx\application\admin\view\common\script.html";i:1531379235;}*/ ?>
<!DOCTYPE html>
<html lang="en">
    <head>
        <meta charset="utf-8">
                ...
                <div class="login-screen">
                    <div class="well">
                        <div class="login-form">
                            <img id="profile-img" class="profile-img-card" src="/szcxmx/public/assets/img/avatar.png" />
                            ...
                            <form action="" method="post" id="login-form">
                                ...
                                <div class="input-group">
                                    ...
                                    <span class="input-group-addon" style="padding:0;border:none;cursor:pointer;">
                                        <img src="<?php echo rtrim('/szcxmx/public/', '/'); ?>/captcha" width="100" height="30" onclick="this.src = '<?php echo rtrim('/szcxmx/public/', '/'); ?>/captcha?r=' + Math.random();"/>
                                    </span>
                                </div>
                                <?php endif; ?>
