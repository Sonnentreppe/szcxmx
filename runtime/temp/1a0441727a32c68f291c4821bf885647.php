...
<script type="text/javascript">
    ...
    <div class="form-group">
        <label class="control-label col-xs-12 col-sm-2"><?php echo __('Pid_id'); ?>:</label>
        <div class="col-xs-12 col-sm-8">
            <input id="c-pid_id" data-rule="required" data-source="product/menu/index" class="form-control selectpage" name="row[pid_id]" type="text" value="<?php echo $row['pid_id']; ?>">
        </div>
    </div>
    <div class="form-group">
